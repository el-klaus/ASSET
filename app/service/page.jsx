         ...
         <section className='px-4 py-14 pb-56'>
          <div>
            <div className='flex flex-col gap-5 lg:pb-2  text-center lg:px-72'>
              ...
              <p className='text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum amet dicta mollitia. ipsum dolor sit amet consectetur adipisicing elit. Ipsum esse excepturi assumenda facere explicabo?</p>
            </div>
          <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-10 py-10 lg:px-12'>
            <div  className='border  hover:bg-slate-300 duration-300 rounded-lg shadow-lg flex flex-col text-center px-6 py-11 gap-5'>
              ...
              <span className='border-b-2 text-cyan-700 font-serif text-5xl'>$100 <span className='text-xl '>minimum</span></span>
              ...
              <Link href={'/deposit'} className='capitalize hover:opacity-55 bg-cyan-700 text-white  p-2'>invest now </Link>
            </div>
            ...
            <div  className='border  hover:bg-slate-300 duration-300 rounded-lg shadow-lg flex flex-col text-center px-6 py-11 gap-5'>
              ...
              <div className='flex gap-2 items-center'>                  <div className='flex gap-10 '>
                  <p className='capitalize '>maximum Earning </p>
